...
```{r, echo=F}
transcript <- read.csv("../data/2015-2016_Stanley_Cup_Final_Transcripts.csv",header=T,stringsAsFactors=F)
cup.final <- read.csv("../data/2015-2016_Stanley_Cup_Final_Scores.csv",header=T,stringsAsFactors=F)
